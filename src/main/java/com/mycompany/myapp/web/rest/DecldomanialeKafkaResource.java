...
@RestController
@RequestMapping("/api/decldomaniale-kafka")
public class DecldomanialeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DecldomanialeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DecldomanialeKafkaResource(KafkaProperties kafkaProperties) {
